...
### Workflows
Overall, please first install the *BiRS* package through *BiRS_1.0.tar.gz*. 
#### Simulation for comparing detection performance of different methods under M-dependence covariance structure in normal settings
...
#### Simulation for comparing detection performance of different methods under Weak-dependence covariance structure in normal settings
...
#### Simulation for comparing the empirical family wise error rate of different methods for different settings.
...
### Data application: identifying signal regions using BiRS-DCF, Q-SCAN, KnockoffScreen and REGENIE
