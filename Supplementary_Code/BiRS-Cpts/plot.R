...
#DTBSB = matrix(apply(DifTiBSB, 2, mean), 5, 4)
DTWBB = matrix(apply(DifTiWBB, 2, mean), 5, 4)
DTSBB = matrix(apply(DifTiSBB, 2, mean), 5, 4)
...
for (j in 1:4)
{
  ...
  lines(delta, TRSBB[ ,j], type = "b", pch = 2, lty = 1, col = 2, lwd = 4)
  lines(delta, TRWBB[ ,j], type = "b", pch = 3, lty = 1, col = 3, lwd = 4)
  legend("right", c("BSD", "SBB", "WBB"), pch = c(1, 2, 3), lty = 1, box.col = "grey", cex = 3.5, col = c(1, 2, 3), lwd = 4)
  dev.off()
  ...
  lines(delta, FRSBB[ ,j], type = "b", pch = 2, lty = 1, col = 2, lwd = 4)
  lines(delta, FRWBB[ ,j], type = "b", pch = 3, lty = 1, col = 3, lwd = 4)
  legend("topright", c("BSD", "SBB", "WBB"), pch = c(1, 2, 3), lty = 1, box.col = "grey", cex = 3.5, col = c(1, 2, 3), lwd = 4)
  dev.off()
}
