...
notation = c(rep('BiRS-DCF', length(BiRSChr11$possel)), rep("Q-SCAN", length(SCANChr11$possel)), 
             rep('KnockoffScreen', length(KSCNChr11$bp)), rep("REGENIE", length(REGNChr11$BP)))
notation = factor(notation, levels = c('BiRS-DCF', 'Q-SCAN', 'KnockoffScreen', 'REGENIE'))
X = c(BiRSChr11$possel, SCANChr11$possel, KSCNChr11$bp, REGNChr11$BP)
Y = c(rep(5, length(BiRSChr11$possel)), rep(4, length(SCANChr11$possel)), 
      rep(3, length(KSCNChr11$bp)), rep(2, length(REGNChr11$BP))) 
...
region = ggplot(data = CHR11Data, aes(x = X, y = Y)) +
         geom_point(stat = 'identity', aes(color = notation), size = 3) + 
...
png(filename = "Chr11.png", width = 1800, height = 600)
print(region)
dev.off()
################################################################################################################################################################################
...
notation = c(rep('BiRS-DCF', length(BiRSChr12$possel)), rep("Q-SCAN", length(SCANChr12$possel)), 
             rep('KnockoffScreen', length(KSCNChr12$bp)), rep("REGENIE", length(REGNChr12$BP)))
notation = factor(notation, levels = c('BiRS-DCF', 'Q-SCAN', 'KnockoffScreen', 'REGENIE'))
X = c(BiRSChr12$possel, SCANChr12$possel, KSCNChr12$bp, REGNChr12$BP)
Y = c(rep(5, length(BiRSChr12$possel)), rep(4, length(SCANChr12$possel)), 
      rep(3, length(KSCNChr12$bp)), rep(2, length(REGNChr12$BP))) 
...
png(filename = "Chr12.png", width = 1800, height = 600)
print(region)
dev.off()
################################################################################################################################################################################
...
notation = c(rep('BiRS-DCF', length(BiRSChr19$possel)), rep("Q-SCAN", length(SCANChr19$possel)), 
             rep('KnockoffScreen', length(KSCNChr19$bp)), rep("REGENIE", length(REGNChr19$BP)))
notation = factor(notation, levels = c('BiRS-DCF', 'Q-SCAN', 'KnockoffScreen', 'REGENIE'))
X = c(BiRSChr19$possel, SCANChr19$possel, KSCNChr19$bp, REGNChr19$BP)
Y = c(rep(5, length(BiRSChr19$possel)), rep(4, length(SCANChr19$possel)), 
      rep(3, length(KSCNChr19$bp)), rep(2, length(REGNChr19$BP))) 
...
png(filename = "Chr19.png", width = 1800, height = 600)
print(region)
dev.off()
