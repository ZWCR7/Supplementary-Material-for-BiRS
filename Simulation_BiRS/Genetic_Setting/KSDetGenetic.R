KSDetG<-function(result.prelim, genotype, window.bed, region.pos = NULL, M = 5, thres.single = 0.01, thres.ultrarare = 25, thres.missing = 0.10, impute.method = 'fixed', bigmemory = T, leveraging = T, LD.filter = NULL)
{
