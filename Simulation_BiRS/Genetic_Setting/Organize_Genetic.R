...
load('BSD_Describe.RData')
load('BSC_Describe.RData')
load('SCQ_Describe.RData')
load('KSD_Describe.RData')

powerBSD = matrix(powerBSD/500, 5, 4)
powerBSC = matrix(powerBSC/500, 5, 4)
powerSCQ = matrix(powerSCQ/500, 5, 4)
powerKSD = matrix(powerKSD/500, 5, 4)
...
delta = c(0.25, 0.30, 0.35, 0.40, 0.45)
for (j in 1:4)
{
  
  namePj = paste0('Figures/Genetic_power_beta', j, '.jpg')
  nameDj = paste0('Figures/Genetic_Diftime_beta', j, '.jpg')
  nameTj = paste0('Figures/Genetic_TDR_beta', j, '.jpg')
  nameFj = paste0('Figures/Genetic_FDR_beta', j, '.jpg')
  
  mainPj = paste0('Genetic Setting, beta = ', j, ' power')
  mainTj = paste0('Genetic Setting, beta = ', j, ' TPR')
  mainFj = paste0('Genetic Setting, beta = ', j, ' FDR')
  
  jpeg(filename = namePj, width = 1200, height = 900)
  ...
  jpeg(filename = nameTj, width = 1200, height = 900)
  ...
  jpeg(filename = nameFj, width = 1200, height = 900)
